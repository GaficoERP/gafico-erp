...
export const ROUTES: RouteInfo[] = [
    ...
    },
    {
        path: '', title: 'Budget', icon: 'icon-wallet', class: 'has-sub', badge: '', badgeClass: 'badge badge-pill badge-danger float-right mr-1 mt-1', isExternalLink: false, submenu: [
            ...
            { path: '', title: 'Exécution Budget', icon: 'ft-play-circle', class: 'has-sub', badge: '', badgeClass: 'badge badge-pill badge-danger float-right mr-1 mt-1', isExternalLink: false, submenu: [
            ...
            { path: '', title: 'Suivi Exécution Budget', icon: 'ft-clipboard', class: 'has-sub', badge: '', badgeClass: 'badge badge-pill badge-danger float-right mr-1 mt-1', isExternalLink: false, submenu: [
